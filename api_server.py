...
MODEL_PATH = os.getenv('MODEL_PATH', 'models/dental_segmentation_simple.pth')
...
def _init_model_on_first_request():
    """Ensure the model is loaded when the first request arrives (works under Gunicorn)."""
    load_semantic_model()
